        ...
        <div className="right-column">
          ...
          <div className="faq-section">
            ...
            <div className="faq-item">
              <p><strong>Q1:</strong> How can I access my results?</p>
              <p><strong>A:</strong> You can access your results by logging into your account and navigating to the "Results" section.</p>
            </div>
            <div className="faq-item">
              <p><strong>Q2:</strong> Can I update my personal information?</p>
              <p><strong>A:</strong> Yes, you can update your personal information in the "Profile" section of your account.</p>
            </div>
          </div>
        </div>
      </div>
